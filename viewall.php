...
$test___=mysqli_query($conn,"SELECT students.*
	FROM students,classes WHERE students.cl_id=classes.cl_id AND classes.cl_id='$clid'") or die(mysqli_error($conn));
...
$std=mysqli_query($conn,"SELECT district.*,students.* FROM district,students 
	WHERE students.s_id='$id' AND students.location=district.district_id") or die(mysqli_error($conn)) ;
...
$clfe=mysqli_fetch_array($clas);
$sname=mysqli_query($conn,"SELECT dean.*,district.* FROM dean,district WHERE district.district_id=dean.location") or die(mysqli_error($conn));
$fename=mysqli_fetch_array($sname);
?>
<!DOCTYPE html>
<html>
<head>
...
<font color: "#83b0d2">
	<tr>
		...
		<td colspan="3"><img src="photos/<?= $feid['profile']?>" height="120" width="120"></td>
	</tr>
<tr>
	<td align="center" style="font-size:20px;border:none;" colspan="17">
	<?php
	...
	<tr>
			...
			<?php
				$ma=mysqli_query($conn,"SELECT * FROM displine_max WHERE y_id='$yid'") or die(mysqli_error($conn));
				if (mysqli_num_rows($ma)>0) {
				while ($maw=mysqli_fetch_array($ma)) {
			...
			<?php
				$totyeardis=0;
				$can=mysqli_query($conn,"SELECT * FROM dis_marks WHERE s_id='$id' AND term_status='term 1' AND year_dis='$yid'") or die(mysqli_error($conn));
				if (mysqli_num_rows($can)>0) {
				while ($dis=mysqli_fetch_array($can)) {
			...
			?>
			<?php
				$disterm2=mysqli_query($conn,"SELECT * FROM dis_marks WHERE s_id='$id' AND term_status='term 2' AND year_dis='$yid'") or die(mysqli_error($conn));
			...
			?>
			<?php
				$ter3dis=mysqli_query($conn,"SELECT * FROM dis_marks WHERE s_id='$id' AND term_status='term 3' AND year_dis='$yid'") or die(mysqli_error($conn));
				if (mysqli_num_rows($ter3dis)>0) {
				while ($ter3marks=mysqli_fetch_array($ter3dis)) {
			...
			?>
			<?php
				if(mysqli_num_rows($can)>0 && mysqli_num_rows($disterm2)>0 && mysqli_num_rows($ter3dis)>0) {
...
$sts=mysqli_query($conn,"SELECT *FROM students WHERE s_id='$id'") or die(mysqli_error($conn));
if ($sts) {
...
$ter=mysqli_query($conn,"SELECT * FROM marks WHERE s_id='$id' AND c_id='{$caursena['c_id']}' AND 
	term_stutus='term 1' AND y_id='$yid'") or die(mysqli_error($conn));
if (mysqli_num_rows($ter)>0) {
$count=1;
while ($term1marks=mysqli_fetch_array($ter)) {
	$totalyea=0;
?>
...
$term2=mysqli_query($conn,"SELECT * FROM marks WHERE s_id='$id' AND c_id='{$caursena['c_id']}'
 AND term_stutus='term 2' AND y_id='$yid'")or die(mysqli_error($conn));
...
$term3=mysqli_query($conn,"SELECT * FROM marks WHERE s_id='$id' AND c_id='{$caursena['c_id']}'
 AND term_stutus='term 3' AND y_id='$yid'") or die(mysqli_error($conn));
...
$set=mysqli_query($conn,"SELECT * FROM setting WHERE s_id='$id' AND c_id='{$caursena['c_id']}' AND
 y_id='$yid'") or die(mysqli_error($conn));
if (mysqli_num_rows($set)>0) {
while ($fetset=mysqli_fetch_array($set)) {
?>
...
$querype=mysqli_query($conn,"INSERT INTO percentages SET perid=null,student_id='$id',
	percentage='$term1perce',term_status='term 1', y_id='$yid'") or die(mysqli_error($conn));
}}
?>
<?php
if (mysqli_num_rows($ter)>0) {
...
$plac=mysqli_query($conn,"SELECT * FROM percentages,students WHERE 
	term_status='term 1' AND percentages.student_id=students.s_id AND students.cl_id='$clid' AND y_id='$yid' ORDER BY percentage DESC") or die(mysqli_error($conn));
$pa=1;
...
$querype2=mysqli_query($conn,"INSERT INTO percentages SET perid=null,student_id='$id',
	percentage='$term2perce',term_status='term 2',y_id='$yid'")or die(mysqli_error($conn));
if ($querype2) {
echo "<td colspan='3' align='right'></td>";
}else{
echo "<td colspan='3'></td>";
...
$plac2=mysqli_query($conn,"SELECT * FROM percentages,students WHERE 
	term_status='term 2' AND percentages.student_id=students.s_id AND students.cl_id='$clid' AND y_id='$yid' ORDER BY percentage DESC") or die(mysqli_error($conn));
$pa2=1;
...
<?php
if (mysqli_num_rows($term3)>0) {
$quese3=mysqli_query($conn,"SELECT * FROM percentages WHERE student_id='$id' and term_status='term 3'");
$che=mysqli_fetch_array($quese);
//var_dump($che);
...
$querype3=mysqli_query($conn,"INSERT INTO percentages SET perid=null,student_id='$id',
	percentage='$term3perce',term_status='term 3',y_id='$yid'")or die(mysqli_error($conn));
}}
?>
...
$plac3q=mysqli_query($conn, $test="SELECT * FROM percentages,students WHERE 
	term_status='term 3' AND percentages.student_id=students.s_id AND students.cl_id='$clid' AND y_id='$yid' ORDER BY percentage DESC") or die(mysqli_error($conn));
$pa3q__=1;
...
$querypeyear=mysqli_query($conn,"INSERT INTO yearperce SET pery_id=null,student_id='$id',
	ypercentages='$yearperca',y_id='$yid'")or die(mysqli_error($conn));
...
$placeyer=mysqli_query($conn,"SELECT * FROM yearperce,students WHERE 
yearperce.student_id=students.s_id AND students.cl_id='$clid' AND y_id='$yid' ORDER BY ypercentages DESC") or die(mysqli_error($conn));
$pyea=1;
...
$querype2=mysqli_query($conn,"INSERT INTO percentages SET perid=null,student_id='1',
	percentage='$term2perce',term_status='term 2'")or die(mysqli_error($conn));
if ($querype2) {
echo "<td colspan='3' align='right'></td>";
}
}else{
...
$querype3=mysqli_query($conn,"INSERT INTO percentages SET perid=null,student_id='1',
	percentage='$term3perce',term_status='term 3'")or die(mysqli_error($conn));
if ($querype3) {
echo "<td colspan='3' align='right'></td>";
}
}else{
...
$ch/*=mysqli_query($conn,"SELECT * FROM places WHERE student_id='1' AND percentage='$term1perce' AND
 term_id='1' AND cl_id='1'") or die(mysqli_error($conn));
if (mysqli_num_rows($ch)>0) {
echo "Percentage inserted";
}else{
$insert=mysqli_query($conn,"INSERT INTO places SET place_id=null,
	student_id='1',percentage='$term1perce',cl_id='1',term_id='1'") or die(mysqli_error($conn));
}*/
?>-->
<td></td>
</tr>
