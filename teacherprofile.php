...
$quer=mysql_query("SELECT * FROM teachers WHERE t_id='{$_SESSION['teacher']}'") or die(mysql_error());
$i=1;
...
$qwer=mysql_query("UPDATE teachers SET phones='$a',username='$b',password='$c' WHERE t_id='{$_SESSION['teacher']}'") or die(mysql_error());
if ($qwer) {
