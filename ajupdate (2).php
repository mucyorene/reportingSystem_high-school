...
<table>
<?php
$upsele=mysql_query("SELECT *FROM students WHERE s_id='$ids'") or die(mysql_error());
...
?>		</td>
	...
	<tr>
		<td>Address</td><td><input type="text" name="location" value="<?php echo $row['location'];?>" size="20" class="inp"></td>
	</tr>
<tr>
...
echo "<option>".$d['classname']."</option>";
	...
	<input type="submit" name="update" value="Update" class="sub"></td>
	</tr>
</table>
<?php
}
