...
$sname=mysql_query("SELECT dean.schoolname FROM dean");
...
<?php
if (mysql_num_rows($term3)>0) {
$quese3=mysql_query("SELECT * FROM percentages,students WHERE term_status='term 2' AND percentages.student_id=students.s_id AND 
...
$placeyer=mysql_query("SELECT * FROM yearperce,students WHERE yearperce.student_id=students.s_id AND 
...
AND caurses.c_id=marks.c_id AND term_stutus='term 1' AND y_id='$yid'") or die(mysql_error());
